...
public class VendingMachineImpl implements VendingMachine{
	...
	private Item collectItem() throws InSufficientChangeToReturnException,InSufficientPaymentException{
		if(isFullPaid()){
			...
			throw new InSufficientChangeToReturnException("Not Sufficient change in the bucket");
   
		}
		long remainingBalance = currentItem.getPrice() - currentBalance;
		throw new InSufficientPaymentException("Part payment is done, Please pay the remaining amount as : ", remainingBalance);
	}
